...
var monica = new _src_user__WEBPACK_IMPORTED_MODULE_4__["default"]('Monica', 'monica@email.com', 'planeta-mujer.org');
console.log(monica);

var profile = Object(_src_user__WEBPACK_IMPORTED_MODULE_4__["createURL"])(monica.name);
console.log(profile);
var image = Object(_src_user__WEBPACK_IMPORTED_MODULE_4__["gravatar"])(monica.email);
console.log(image);
...
/*!***********************!*\
  !*** ./src/config.js ***!
  \***********************/
/*! exports provided: apiKey, url, sayHi, old, dog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "old", function() { return age; });
...
function createURL(name) {
    return _config__WEBPACK_IMPORTED_MODULE_1__["url"] + '/users/' + slug__WEBPACK_IMPORTED_MODULE_0___default()(name);
}

function gravatar(email) {
    var hash = base_64__WEBPACK_IMPORTED_MODULE_2___default.a.encode(email);
    var photoUrl = 'https://www.gravatar.com/avatar/' + hash;
    return photoUrl;
}
